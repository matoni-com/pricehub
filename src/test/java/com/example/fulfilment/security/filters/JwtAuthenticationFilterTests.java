...
public class JwtAuthenticationFilterTests {
    ...
    @Test
    @DisplayName("Filter pull token from header, delegates it to auth manager, populates security context and calls chain.doFilter")
    public void filterAuthenticatesRequestWithBearerToken() throws ServletException, IOException {
        ...
        when(authenticationManager.authenticate(new JwtAuthenticationToken("some_token"))).thenReturn(new JwtAuthenticationToken("some_user", "some_token", null));
        ...
        assertEquals(new JwtAuthenticationToken("some_user", "some_token", null), SecurityContextHolder.getContext().getAuthentication());
