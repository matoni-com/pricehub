...
import com.matoni.pricehub.security.exceptionhandling.RestAccessDeniedHandler;
import com.matoni.pricehub.security.exceptionhandling.RestAuthenticationEntryPoint;
import com.matoni.pricehub.security.filters.JwtAuthenticationFilter;
...
public class SecurityConfig {
  ...
  @Bean(name = "maggieJwt")
  public AuthenticationManager maggieJwtAuthManager(
  ...
  public SecurityFilterChain securityFilterChain(
    ...
    return http.securityMatcher("/web/**", "/authenticate", "/hello", "/products/**")
